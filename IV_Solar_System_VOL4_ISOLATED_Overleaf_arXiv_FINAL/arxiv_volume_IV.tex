...
% arXiv top-level entry.  The literal input below also makes the Overleaf
% subfolder entry visible to arXiv's static source scanner.
\def\ARXIVBUILD{1}
\input{IV_Solar_System_Volume/volume_IV.tex}
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage{textcomp}
\usepackage{vol4_kultem}
...
\input{vol4_front.tex}
\input{vol4_covers.tex}

...
preselect the stars that host wide giants. The imaging visits and external
monitoring data supply the stellar-activity reference required by
Section~\ref{sec:activity}. No dedicated time-domain survey is assigned to

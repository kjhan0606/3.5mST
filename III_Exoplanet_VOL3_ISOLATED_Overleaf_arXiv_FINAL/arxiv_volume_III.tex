% arXiv top-level file for Volume III. Compile with pdfLaTeX.
\documentclass[oneside,a4paper,11pt,explicit]{book}
\def\ARXIVBUILD{1}
\input{III_Exoplanet_Volume/volume_III.tex}
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage{textcomp}
\usepackage{vol3_kultem}
...
\input{vol3_front.tex}
\input{vol3_covers.tex}
...
\MakeVolumeBody
% Explicit inclusion is required for arXiv's dependency scanner.
\include{vol3_exoplanet}

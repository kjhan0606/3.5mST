% arXiv top-level file for Volume II. Compile with pdfLaTeX.
\documentclass[oneside,a4paper,11pt,explicit]{book}
\def\ARXIVBUILD{1}
\input{II_Cosmology_Volume/volume_II.tex}
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage{textcomp}
\usepackage{vol2_kultem}
...
\input{vol2_front.tex}
\input{vol2_covers.tex}
...
\MakeVolumeBody
% Keep the chapter source explicit here. arXiv's dependency scanner does not
% expand file-inclusion commands hidden inside user-defined macros.
\include{vol2_cosmology}

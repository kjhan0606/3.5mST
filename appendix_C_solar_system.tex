...
Pixel scale & 0.35 arcsec pixel$^{-1}$ & 0.35 arcsec pixel$^{-1}$\\
...
the flyby. A symmetric-log horizontal scale keeps both hour-scale and
month-scale lead times visible. The center and right panels compare the local force model with

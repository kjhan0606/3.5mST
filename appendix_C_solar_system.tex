...
\end{equation}
where the left-hand side $\dot N_{\rm src}$ is the detected source
...
Pivot wavelength ($\lambda_p$) & 4.56\,$\mu$m & 7.75\,$\mu$m\\
...
We generated the reference population between 30\,m and 3\,km with the public
NEOMOD3 Fortran simulator \cite{Nesvorny2024}. The resulting realization
contains 344,458 NEOs. The sample contains 19,694 objects larger than 140\,m
and 801 objects larger than 1\,km. These counts agree with the published estimates of
...
drawn uniformly. The orbits were propagated with
...
\begin{longtable}{@{}P{30mm}P{36mm}P{45mm}P{45mm}@{}}
\toprule
...
\begin{tabularx}{0.99\textwidth}{@{}P{23mm}P{25mm}P{18mm}ZZZZ@{}}
\toprule
...
\textbf{\color{cGold}Total $\geq140$ m} &
...
$V$ exposure with a $5\sigma$ limit of $V_{\rm AB}=26.48$. The assumed
...
\midrule
5\,m & Small-object sensitivity & 0.242\,au & 21.0 and 14.0 days\\
10\,m & Warning threshold scale & 0.416\,au & 36.0 and 24.0 days\\
20\,m & Chelyabinsk scale & 0.691\,au & 59.8 and 39.9 days\\
50\,m & Tunguska scale & 1.273\,au & 110.2 and 73.5 days\\
140\,m & NASA census threshold & 2.387\,au & 206.6 and 137.8 days\\
1\,km & Large-object reference & 7.100\,au & 614.7 and 409.8 days\\
\bottomrule
\end{tabularx}
...
\begin{tabular}{@{}M{42mm}C{34mm}M{80mm}@{}}
\toprule
...
astrometry from the Minor Planet Center (MPC) and retains the observatory codes,
...
$\Delta$ is \textbf{CODES result minus NASA/JPL official result}.
...
\caption{Dense NASA/JPL comparison for the independent 150-year CODES
propagation of 1P/Halley. Teal curves show the osculating period, semimajor
axis, and perihelion distance derived from the CODES state. Gold diamonds
show NASA/JPL Horizons solution \#75 at 397 independently requested epochs.
The sampling interval is six months across 1850--2000 and one month within
two years of the 1910 and 1986 perihelia. The dashed vertical lines mark
those perihelia. CODES reproduces the phase and amplitude of the JPL
oscillations in every panel. The period residual has an RMS of 0.27\,d and a
maximum magnitude of 3.79\,d. The semimajor-axis residual has an RMS of
17{,}189\,km and a maximum magnitude of 244{,}589\,km. The
perihelion-distance residual has an RMS of 3.79\,km and a maximum magnitude
of 27.26\,km. The JPL states are used only for post-propagation comparison
and are not ingested by CODES after the 1850 initial epoch.}
...
not merely the parsing of a sequence of JPL records. The dense comparison
demonstrates that CODES reproduces the time-dependent oscillations and the
two physical perihelion passages across 150 years.
...
\href{https://www.nasa.gov/wp-content/uploads/2015/12/neo-impact-threat-emergency-protocols-jan2021.pdf}
{NASA report archive}.

\bibitem{NASASDT2017}
NASA 2017,
``New Report Assesses Status of Detecting Near-Earth Asteroids.''
\href{https://www.nasa.gov/solar-system/new-report-assesses-status-of-detecting-near-earth-asteroids/}
{NASA planetary-defense report summary}.

...
\newcommand{\MakeFrontCover}{%
  ...
  {\color{muted}\small Korea Astronomy and Space Science Institute \textperiodcentered\
    ...
    Korea Institute for Advanced Study \textperiodcentered\ Pusan National University\par}
  \vspace{5mm}
...
\newcommand{\MakeColophon}{%
  ...
  \noindent{\color{muted}\footnotesize
    ...
    Korea Institute for Advanced Study (KIAS), and Pusan National University
    (PNU).\\[5mm]

...
%
    ...
    Institute (KASI), University of Ulsan (UOU), the Space Telescope Science Institute (STScI), the Korea Institute for Advanced Study (KIAS), Pusan National University
    (PNU) , Korea National University of Education (KNUE) and Seoul National University
    (SNU).\\[5mm]

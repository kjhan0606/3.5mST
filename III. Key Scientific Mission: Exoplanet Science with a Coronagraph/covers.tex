...
\newcommand{\MakeFrontCover}{%
  ...
  \vspace{3mm}
  {\color{muted}\small
    $^{1}$ Korea Astronomy and Space Science Institute \textperiodcentered\
    $^{2}$ University of Ulsan \\
    $^{3}$ Korea Institute for Advanced Study \textperiodcentered\
...
\newcommand{\MakeColophon}{%
  ...
  \noindent{\color{muted}\footnotesize
    ...
    {\color{ink}\bfseries Suggested citation:} Kim, J., Lee, S.-H., Kang, Y.-W.,

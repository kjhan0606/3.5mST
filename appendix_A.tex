...
\end{equation}
or about 4600 pixels at two pixels per resolution element. The whole-wavelength dispersion is still too long to lay over a crowded field. From the start, the baseline design is therefore to split the spectrum into two band-limited arms and observe each tile at three orientations.

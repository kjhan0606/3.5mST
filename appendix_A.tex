...
The baseline sensitivities quoted in this appendix do not apply a cosmic-ray loss correction. The planned observing sequence uses multiple exposures. The resulting efficiency loss will enter the final exposure-time budget after the detector readout pattern, ramp-fitting performance, and in-orbit cosmic-ray rate are fixed. Cosmic rays therefore do not change the present planning depth or the science forecasts.

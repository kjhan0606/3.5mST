...
\hypersetup{
  ...
  citecolor=teal,
  urlcolor=gold,
  pdftitle={Volume V: Compact-Object Time-Domain Science},
  pdfauthor={Juhan Kim}
}
...
\fancyhead[R]{\sffamily\footnotesize Volume V: Compact Objects}
\fancyfoot[C]{\sffamily\footnotesize V-\thepage}
...
\renewcommand{\thesubsection}{V.\arabic{section}.\arabic{subsection}}
\renewcommand{\thesubsubsection}{V.\arabic{section}.\arabic{subsection}.\arabic{subsubsection}}
...
Volume V: Compact-Object Time-Domain Science}\\[2.2mm]
...
\cite{roy2026V,wevers2026V}. This volume defines a narrower and testable
...
\begin{figure}[tp]
\centering
\includegraphics[width=0.95\textwidth,height=0.62\textheight]{vol5_gw170817_xshooter.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.94\textwidth]{vol5_dwarf_nova_typical_disk_outburst.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.83\textwidth]{vol5_ugem_lamost_spectrum.jpeg}
...
\begin{figure}[tp]
\centering
\includegraphics[width=0.78\textwidth]{vol5_ugem_wht_hbeta_double_peak.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{vol5_compact_etc_reference_cases.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{vol5_compact_scene_recovery.png}
...
Volume V. The allocation equals 1.41 per cent of the five-year wall clock.
Table~\ref{tab:compact_five_year} gives the program totals.

\begin{table}[H]
\centering
\caption{Database-driven five-year reference allocation for Volume V. The
...
\midrule
\textbf{Volume V total} & \textbf{1--5} & \textbf{618.3} &
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{vol5_appendix_X_five_year_timeline.png}
\caption{Weekly Volume V allocation generated from the shared observing
database. Color gives the fraction of one 168-hr week assigned to each
program. The color scale uses the largest Volume V allocation and the gray

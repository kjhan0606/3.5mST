...
% arXiv top-level entry. The literal input below also marks the Overleaf
% subfolder entry as used for arXiv's static source scanner.
\def\ARXIVBUILD{1}
\input{V_Compact_Object_Volume/volume_V.tex}
\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage{textcomp}
\usepackage{vol5_kultem}
...
\input{vol5_front.tex}
\input{vol5_covers.tex}

...
Appendix X. The allocation equals 1.41 per cent of the five-year wall clock.
Table~\ref{tab:compact_five_year} gives the program totals.

\begin{table}[H]
\centering
\caption{Database-driven five-year reference allocation for Appendix X. The
...
\midrule
\textbf{Appendix X total} & \textbf{1--5} & \textbf{618.3} &
...
\caption{Weekly Appendix X allocation generated from the shared observing
database. Color gives the fraction of one 168-hr week assigned to each
program. The color scale uses the largest Appendix X allocation and the gray

...
The main proposal identifies compact objects as a scientific theme. A
testable program must specify the observables and observing interval for each
source class. Three experiments define the compact-object program. Rapid
observations of merger counterparts measure spectral evolution over hours to
days. Repeated spectra of accreting binaries measure line profiles as functions
of orbital phase and accretion state. Uninterrupted imaging of white dwarfs
measures pulsation frequencies. Spectroscopy determines the atmospheric
boundary condition required by the asteroseismic model.

...
The native resolving power provides different measurements for different source
...
The minimum mission-level requirement is not merely a fast slew. Before the
...
ToO response & Goal $<4$ hr, baseline $<12$ hr & Records early kilonova and
...
transitions between states, and transient spectral evolution when the ETC establishes the
required S/N.

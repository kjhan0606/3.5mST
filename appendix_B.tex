...
Published results from Kepler, TESS, and other transit surveys provide
comparison samples for the directly imaged population. Measurements of
host-star variability support the atmospheric analysis. This key science follows the exoplanet
...
spectroscopy \cite{roy2026B,wevers2026B}. This volume defines a more specific
...
$\sim10^{-9}$ regime. As illustrated in Figure~\ref{fig:fgk20-observability}, 
...
\bibitem{roy2026B} Roy A., et al., The Lazuli Space Observatory: Architecture \& Capabilities, arXiv:2601.02556 (2026).
\bibitem{wevers2026B} Wevers T., et al., The Lazuli Space Observatory: Opportunities for time-domain and multi-messenger astronomy, arXiv:2606.17136 (2026).
\end{thebibliography}

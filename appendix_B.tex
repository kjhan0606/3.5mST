...
facility for the solar neighborhood. 
...
The primaryexploration sample is therefore defined as the 20 nearest stellar components belonging to 13 stellar systems. This sample size represents a practical
...
\cite{Kopparapu2013,Stark2014}. Repeated high-contrast observations will be used to 
...
that received by Earth \cite{Kopparapu2013}. Their habitable zones also lie at
...
\cite{Kopparapu2013,Tuchow2024}. This does not imply that planets around M dwarfs
...
\cite{Kopparapu2013,Kopparapu2014}. Representative effective temperatures and
luminosities for the individual spectral subtypes are adopted from empirical
main-sequence stellar calibrations \cite{PecautMamajek2013}.

The HZ boundaries are calculated using the effective stellar-flux formulation
developed for main-sequence stars \cite{Kopparapu2013,Kopparapu2014}. Defining
...
Early Mars boundaries \cite{Kopparapu2013,Kopparapu2014}. These coefficients
...
Kopparapu et al.~\cite{Kopparapu2014}. The Recent Venus, maximum-greenhouse,
...
\cite{Kopparapu2013,Kopparapu2014}. As illustrated in
...
Kopparapu et al. \cite{Kopparapu2013,Kopparapu2014}, while representative
main-sequence stellar parameters are based on the dwarf sequence of
Pecaut \& Mamajek \cite{PecautMamajek2013}. Figure~\ref{fig:fgk20-observability} places the same targets
...
where geometrically accessible \cite{Kopparapu2013}.
...
defined in Section~\ref{sec:hz-target-selection}. Particular attention will be given to planets whose
orbits lie wholly or substantially within the conservative HZ, while planets
occupying the optimistic HZ will remain part of the broader habitability assessment.
Repeated observations are especially important for systems with partially accessible
HZs, where orbital motion can bring a planet outside the IWA and provide additional
opportunities for detection and characterization.
...
Roman observatory \cite{romanfor}. Reflected-light imaging at $10^{-9}$ contrast needs the
...
Nearest Stellar Systems Survey & Year 1--2 & 300--500 hr & Systematic direct-imaging survey of the 20 nearest stellar components; reference atlas of nearby stellar systems; initial census of giant planets, circumstellar disks, and reflected-light companions.\\

Nearest FGK HZ Systems Survey & Year 1--2 & 1600--2400 hr & Direct-imaging survey of the 20 nearest FGK main-sequence stars, prioritizing fully accessible conservative HZs; search for potentially habitable planets, orbital confirmation, and reflected-light spectroscopic characterization of the most promising candidates.\\

Young giants and debris disks & Years 2--3 & 250--450 hr & Thermal-emission imaging of nearby moving-group giants and scattered-light disks while the wavefront control matures.\\
First-light known giants & Years 2--3 & 300--500 hr & Attempt reflected-light recovery of the candidates in Table~\ref{tab:firstlight} after phase and throughput review.\\
Mature-giant search program & Years 3--5 & 1600--2400 hr & Search a reviewed stellar sample after $10^{-9}$ performance is demonstrated. Confirmed detections receive spectroscopic follow-up.\\
Giant orbit determination & Years 3--5 & 600--1000 hr & Repeat epochs across the mission for orbital arcs and dynamical masses.\\
...
\begin{figure}[tp]
\centering
\includegraphics[width=\textwidth]{exo_timeline_rev.png}
...
\bibitem{Kopparapu2013} Kopparapu, R.~K., Ramirez, R., Kasting, J.~F., Eymet, V., Robinson, T.~D., Mahadevan, S., Terrien, R.~C., Domagal-Goldman, S., Meadows, V., \& Deshpande, R. 2013, Habitable Zones Around Main-Sequence Stars: New Estimates, ApJ, 765, 131.
\bibitem{Stark2014}
...
JATIS, 5, 024009.
\bibitem{Kopparapu2014} Kopparapu, R.~K., Ramirez, R.~M., SchottelKotte, J., Kasting, J.~F., Domagal-Goldman, S., \& Eymet, V. 2014, Habitable Zones Around Main-Sequence Stars: Dependence on Planetary Mass, ApJL, 787, L29.
\bibitem{PecautMamajek2013} Pecaut, M.~J., \& Mamajek, E.~E.
